"""Validator for Cycle / FFT / Ehlers base features."""
...
class FeatureValidationError(ValueError):
    """Raised when validation fails for cycle_fft_ehlers features."""
...
def validate_cycle_fft_ehlers_features(df: pd.DataFrame) -> Dict[str, Any]:
    """Validate the cycle_fft_ehlers feature family against the schema."""
...
__all__ = ["validate_cycle_fft_ehlers_features", "FeatureValidationError"]
